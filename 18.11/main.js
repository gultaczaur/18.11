...
//     try {
//         let map = new Map();
//         users.filter(user => { map.set(user.id, user); });
//         return map;
...
//     if (getId) {
//         console.log(`ID:${id} ${getId.role} rolundadır`);
//     } else
//         console.log(`ID:${id} mövcud deyil`);
// }
...
//         if (getId) {
//             map.delete(id);
//             throw new Error(`ID:${id} silindi`)

//         } else {
//             throw new Error(`ID:${id} mövcud deyil`)
//         }
...
//     let turnToObj = Object.fromEntries(map)
//     console.log("Alınan nəticə object-ə çevrilmişdir:", turnToObj);

//     let turnToArray = Object.entries(turnToObj)
//     console.log("Alınan nəticə array-ə çevrilmişdir:", turnToArray);
